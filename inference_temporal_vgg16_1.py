...
with tf.Graph().as_default():
    ...
    checkpoint_path = 'checkpoints/finetune_temporal_vgg16_10_06.ckpt'
    ...
    test_dataset, test_labels = ucf101_utils.load_flow_dataset(batch_size=test_dataset_num_clips,
    ...
    print('\tImage tensor: ', test_dataset.shape)
    print('\tLabels tensor: ', test_labels.shape)
