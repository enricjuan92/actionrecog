...
class vgg16:
    ...
    def convlayers(self):
        ...
        # conv1_1
        with tf.name_scope('spatial_vgg16/conv1/conv1_1') as scope:
        ...
        # conv1_2
        with tf.name_scope('spatial_vgg16/conv1/conv1_2') as scope:
        ...
        # conv2_1
        with tf.name_scope('spatial_vgg16/conv2/conv2_1') as scope:
        ...
        # conv2_2
        with tf.name_scope('spatial_vgg16/conv2/conv2_2') as scope:
        ...
        # conv3_1
        with tf.name_scope('spatial_vgg16/conv3/conv3_1') as scope:
        ...
        # conv3_2
        with tf.name_scope('spatial_vgg16/conv3/conv3_2') as scope:
        ...
        # conv3_3
        with tf.name_scope('spatial_vgg16/conv3/conv3_3') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 256, 256], dtype=tf.float32,
                                                     stddev=1e-1), name='weights')
        ...
        # conv4_1
        with tf.name_scope('spatial_vgg16/conv4/conv4_1') as scope:
        ...
        # conv4_2
        with tf.name_scope('spatial_vgg16/conv4/conv4_2') as scope:
        ...
        # conv4_3
        with tf.name_scope('spatial_vgg16/conv4/conv4_3') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 512, 512], dtype=tf.float32,
                                                     stddev=1e-1), name='weights')
        ...
        # conv5_1
        with tf.name_scope('spatial_vgg16/conv5/conv5_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 512, 512], dtype=tf.float32,
                                                     stddev=1e-1), name='weights')
        ...
        # conv5_2
        with tf.name_scope('spatial_vgg16/conv5/conv5_2') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 512, 512], dtype=tf.float32,
                                                     stddev=1e-1), name='weights')
